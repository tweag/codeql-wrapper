...
class SarifUploadUseCase:
    ...
    def _upload_file(self, sarif_file: Path, request: SarifUploadRequest) -> None:
        ...
        try:
            ...
            raise Exception(f"SARIF upload timed out after {self.UPLOAD_TIMEOUT_SECONDS} seconds")
        ...
        if result.returncode != 0:
            ...
            raise Exception(f"CodeQL upload failed (exit code {result.returncode}): {error_msg}")
